...
@SourceType(value = "OdooARP", label = "Odoo",uiConfig = "odoo-layout.json")
public class OdooConf extends AbstractArpConf<OdooConf> {
  private static final String ARP_FILENAME = "arp/implementation/odoo-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.odoo.OdooDriver";
